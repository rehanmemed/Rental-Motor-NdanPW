        ...
        >
          <div class="col-md-9 ftco-animate pb-5">
            <p class="breadcrumbs">
              ...
              ></span>
              <span>Jasa <i class="ion-ios-arrow-forward"></i></span>
            </p>
        ...
        <div class="row">
          <div class="col-md-3">
            <div class="services services-2 w-100 text-center">
              ...
              <div class="text w-100">
                <h3 class="heading mb-2">Ambil Ditempat</h3>
                <p>
                  Ambil motor langsung ke tempat penyewaan.
                </p>
              </div>
            </div>
          </div>
          <div class="col-md-3">
            <div class="services services-2 w-100 text-center">
              ...
              <div class="text w-100">
                <h3 class="heading mb-2">Jaminan Mudah</h3>
                <p>
                 Jaminan penyewaan mudah hanya dengan salah satu idenditas.
                </p>
              </div>
            </div>
          </div>
          <div class="col-md-3">
            <div class="services services-2 w-100 text-center">
              ...
              <div class="text w-100">
                <h3 class="heading mb-2">Booking Mudah</h3>
                <p>
                  Booking dapat dilakukan diwebsite dengan mudah.
                </p>
              </div>
            </div>
          </div>
          <div class="col-md-3">
            <div class="services services-2 w-100 text-center">
              ...
              <div class="text w-100">
                ...
                <p>
                  Antar jemput motor untuk customer yang jauh ketempat penyewaan.
                </p>
              </div>
            </div>
          </div>
